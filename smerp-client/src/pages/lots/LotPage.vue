...
<script setup>
import { ref, onMounted, computed, defineAsyncComponent, shallowRef, watch } from 'vue';
...
const Views = {
  list: defineAsyncComponent(() => import("@/components/lots/LotListWithPagination.vue")),
  create: defineAsyncComponent(() => import("@/components/lots/CreateLotForm.vue")),
};
